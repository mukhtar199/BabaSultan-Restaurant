              ...
              {orders.length === 0 ? (
                ...
                orders.map((o) => (
                  <tr key={o.id} className="hover:bg-slate-800/40 transition">
                    ...
                    <td className="py-4 px-6 font-bold text-white">${o.totalAmount.toFixed(2)}</td>
                    <td className="py-4 px-6 text-slate-400">${o.cogs.toFixed(2)}</td>
                    <td className="py-4 px-6 font-bold text-emerald-400">${o.profit.toFixed(2)}</td>
