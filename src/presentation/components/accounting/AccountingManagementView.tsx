...
export const AccountingManagementView: React.FC = () => {
  const { user, t, language, dir } = useAuth();
  const isRtl = dir === 'rtl';
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-slate-900 border border-slate-800 p-5 rounded-3xl space-y-2">
              ...
              <p className="text-2xl font-extrabold text-white">${(cashOnHand + bankBalance).toLocaleString('en-US', { minimumFractionDigits: 2 })}</p>
              <p className="text-[10px] text-slate-500 font-medium">Cash Till: ${cashOnHand.toFixed(2)} | Bank: ${bankBalance.toFixed(2)}</p>
            </div>
          </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="p-3 bg-slate-800/60 rounded-xl border border-slate-700/60 flex items-center justify-between">
                    <div>
                      ...
                      <span className="text-sm font-bold text-emerald-400">${totalReceivables.toFixed(2)}</span>
                    </div>
                  ...
                  <div className="p-3 bg-slate-800/60 rounded-xl border border-slate-700/60 flex items-center justify-between">
                    <div>
                      ...
                      <span className="text-sm font-bold text-rose-400">${totalPayables.toFixed(2)}</span>
                    </div>
                ...
                <tbody className="divide-y divide-slate-800/60 font-medium">
                  {receivables.map(r => (
                    <tr key={r.id} className="hover:bg-slate-800/40 transition">
                      ...
                      <td className="p-4 text-right font-mono text-white">${r.totalAmount.toFixed(2)}</td>
                      <td className="p-4 text-right font-mono text-emerald-400">${r.paidAmount.toFixed(2)}</td>
                      <td className="p-4 text-right font-mono font-bold text-rose-400">${r.remainingBalance.toFixed(2)}</td>
                      <td className="p-4">
                        <span
                ...
                <tbody className="divide-y divide-slate-800/60 font-medium">
                  {payables.map(p => (
                    <tr key={p.id} className="hover:bg-slate-800/40 transition">
                      ...
                      <td className="p-4 text-right font-mono text-white">${p.totalAmount.toFixed(2)}</td>
                      <td className="p-4 text-right font-mono text-emerald-400">${p.paidAmount.toFixed(2)}</td>
                      <td className="p-4 text-right font-mono font-bold text-rose-400">${p.remainingBalance.toFixed(2)}</td>
                      <td className="p-4">
                        <span
                          className={`px-2 py-0.5 rounded-full text-[10px] font-bold ${
                            p.status === 'Paid'
              ...
              <div className="space-y-3">
                {cashRegisters.map(c => (
                  <div key={c.id} className="p-4 bg-slate-950 border border-slate-800 rounded-2xl flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                      <div className="text-right">
                        <p className="text-xs font-bold text-white">Float: ${c.openingBalance.toFixed(2)}</p>
                        <p className="text-[10px] text-emerald-400 font-medium">Sales: +${c.cashSales.toFixed(2)}</p>
                      </div>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 max-w-md w-full space-y-4 shadow-2xl">
            ...
            <form onSubmit={handleRecordARPayment} className="space-y-3 text-xs">
              <div className="p-3 bg-slate-950 rounded-2xl border border-slate-800 space-y-1">
                ...
                <p className="text-xs text-rose-400 font-bold font-mono">Remaining Balance: ${selectedReceivable.remainingBalance.toFixed(2)}</p>
              </div>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 max-w-md w-full space-y-4 shadow-2xl">
            ...
            <form onSubmit={handleRecordAPPayment} className="space-y-3 text-xs">
              <div className="p-3 bg-slate-950 rounded-2xl border border-slate-800 space-y-1">
                ...
                <p className="text-xs text-rose-400 font-bold font-mono">Bill Remaining: ${selectedPayable.remainingBalance.toFixed(2)}</p>
              </div>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 max-w-md w-full space-y-4 shadow-2xl">
            ...
            <form onSubmit={handleCloseRegister} className="space-y-3 text-xs">
              <div className="p-3 bg-slate-950 rounded-2xl border border-slate-800 space-y-1">
                ...
                <p className="text-slate-400">Opening Float: ${selectedRegisterToClose.openingBalance.toFixed(2)}</p>
                <p className="text-emerald-400 font-bold">Expected Cash: ${selectedRegisterToClose.expectedClosingBalance.toFixed(2)}</p>
              </div>
