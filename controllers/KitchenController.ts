...
export class KitchenController {
  ...
  public subscribeTickets(callback: (tickets: KitchenTicket[]) => void): () => void {
    return this.repository.subscribeKitchenTickets(callback);
  }

  public subscribeStations(callback: (stations: KitchenStation[]) => void): () => void {
    return this.repository.subscribeKitchenStations(callback);
  }
