...
export class AccountingController {
  ...
  async openRegister(registerName: string, branchName: string, openingBalance: number, openedBy: string): Promise<CashRegister> {
    return await this.repo.openCashRegister(registerName, branchName, openingBalance, openedBy);
  }
