...
export const OwnerView: React.FC<OwnerViewProps> = ({
  ...
  const todayCogs = todayOrders.reduce((sum, o) => sum + (o.cogs || o.totalAmount * 0.45), 0);
  ...
  // Liquidity & Cash Flow
  const cashAccount = accounts.find(a => a.type === 'cash')?.balance || 1850;
  const bankAccount = accounts.find(a => a.type === 'bank')?.balance || 12450;
