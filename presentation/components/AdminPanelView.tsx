        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-slate-900 border border-slate-800 rounded-3xl p-5 shadow-lg">
              ...
              <h3 className="text-2xl font-extrabold text-white mt-2">${totalSales.toFixed(2)}</h3>
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-3xl p-5 shadow-lg">
              ...
              <h3 className="text-2xl font-extrabold text-amber-400 mt-2">${totalCOGS.toFixed(2)}</h3>
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-3xl p-5 shadow-lg">
              ...
              <h3 className="text-2xl font-extrabold text-rose-400 mt-2">${totalExpensesAmt.toFixed(2)}</h3>
              ...
              <tbody className="divide-y divide-slate-800/60 text-xs">
                {products.map(p => (
                  <tr key={p.id} className="hover:bg-slate-800/40">
                    ...
                    <td className="py-3 px-4 font-extrabold text-emerald-400">${p.price.toFixed(2)}</td>
                    <td className="py-3 px-4 text-slate-400">${p.cost.toFixed(2)}</td>
              ...
              <tbody className="divide-y divide-slate-800/60 text-xs">
                {orders.map(o => (
                  <tr key={o.id} className="hover:bg-slate-800/40">
                    ...
                    <td className="py-3 px-4 font-extrabold text-white">${o.totalAmount.toFixed(2)}</td>
              ...
              <tbody className="divide-y divide-slate-800/60 text-xs">
                {ingredients.map(ing => (
                  <tr key={ing.id} className="hover:bg-slate-800/40">
                    ...
                    <td className="py-3 px-4 text-slate-400">${ing.costPerUnit.toFixed(2)}</td>
              ...
              <tbody className="divide-y divide-slate-800/60 text-xs">
                {expenses.map(e => (
                  <tr key={e.id} className="hover:bg-slate-800/40">
                    ...
                    <td className="py-3 px-4 font-extrabold text-amber-400">${e.amount.toFixed(2)}</td>
              ...
              <tbody className="divide-y divide-slate-800/60 text-xs">
                {revenues.map(r => (
                  <tr key={r.id} className="hover:bg-slate-800/40">
                    ...
                    <td className="py-3 px-4 font-extrabold text-teal-400">${r.amount.toFixed(2)}</td>
