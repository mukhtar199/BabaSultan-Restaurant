            ...
            <>
              ...
              <div className="space-y-1 text-[11px] border-b border-dashed border-slate-800 pb-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-emerald-400 font-bold uppercase">{receipt.orderType.replace('_', ' ')}</span>
                </div>
                {receipt.tableNumber && (
                  <div className="flex justify-between">
              ...
              <div className="space-y-1 text-xs">
                ...
                <div className="flex justify-between text-sm font-extrabold text-white pt-2 border-t border-slate-800">
                  ...
                  <span className="text-emerald-400">${receipt.totalAmount.toFixed(2)}</span>
                </div>
                {receipt.amountTendered !== undefined && (
                  <div className="flex justify-between text-[10px] text-slate-400 pt-1">
                    <span>Tendered ({receipt.paymentMethod.toUpperCase()}): ${receipt.amountTendered.toFixed(2)}</span>
